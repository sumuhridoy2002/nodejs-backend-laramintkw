...
const updateServiceWithDeleteImgTeamBanner = async (Request, DataModel) => {
  ...
  try {
    ...
    if (deleteImg.result === "ok") {
      var pullImg = await DataModel.findOneAndUpdate(
        ...
        { $pull: { teamImgBanner: { public_id: imgId } } }
      );
...
module.exports = updateServiceWithDeleteImgTeamBanner;
