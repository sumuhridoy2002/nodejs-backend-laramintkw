...
const updateServiceWithDeleteImgForTermOfUse = async (Request, DataModel) => {
  ...
  try {
    ...
    if (deleteImg.result === "ok") {
      var pullImg = await DataModel.findOneAndUpdate(
        ...
        { $pull: { termOfUse: { public_id: imgId } } }
      );
...
module.exports = updateServiceWithDeleteImgForTermOfUse;
